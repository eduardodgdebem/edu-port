...
var PcgRandom = (function () {
  ...
  function e(t, e, s, n, i) {
    var a = ((s >>> 16) * (65535 & i)) >>> 0,
      h = ((65535 & s) * (i >>> 16)) >>> 0,
      o = ((65535 & s) * (65535 & i)) >>> 0,
      u = ((s >>> 16) * (i >>> 16) + ((h >>> 16) + (a >>> 16))) >>> 0;
    (h = (h << 16) >>> 0),
      (o = (o + h) >>> 0),
      h >>> 0 > o >>> 0 && (u = (u + 1) >>> 0),
      (a = (a << 16) >>> 0),
  ...
  function s(t, e, s, n, i) {
    var r = (e + n) >>> 0,
      a = (s + i) >>> 0;
    s >>> 0 > a >>> 0 && (r = (r + 1) | 0), (t[0] = r), (t[1] = a);
  }
  var n = 335903614,
    i = 4150755663;
  (t.prototype.setSeed = function (t, e, r, a) {
    return (
      null == e && null == t
        ? ((e = (4294967295 * Math.random()) >>> 0), (t = 0))
        : null == e && ((e = t), (t = 0)),
      null == a && null == r
        ? ((a = this.state_ ? this.state_[3] : i),
          (r = this.state_ ? this.state_[2] : n))
        : null == a && ((a = r), (r = 0)),
      (this.state_ = new Int32Array([0, 0, r >>> 0, (1 | a) >>> 0])),
      this.next_(),
      s(this.state_, this.state_[0], this.state_[1], t >>> 0, e >>> 0),
      this.next_(),
      this
    );
  }),
  ...
  var a = 1481765933,
    h = 1284865837;
  (t.prototype.next_ = function () {
    var t = this.state_[0] >>> 0,
      n = this.state_[1] >>> 0;
    e(this.state_, t, n, a, h),
      s(
        this.state_,
        this.state_[0],
        this.state_[1],
    ...
    (t.prototype.integer = function (t) {
  ...
  return (
    (t.prototype.number = function () {
      var t = 1 * (67108863 & this.next_()),
        e = 1 * (134217727 & this.next_());
      return (t * u + e) / o;
    }),
    t
  );
})();
"undefined" != typeof module && module.exports && (module.exports = PcgRandom);
